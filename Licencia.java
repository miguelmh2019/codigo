...
public class CcuarentaytresLicencia extends JFrame implements ActionListener, ChangeListener{
  ...
  public CcuarentaytresLicencia(){
    ...
    textarea1.setText("\n\n          TÉRMINOS Y CONDICIONES" +
                    ...
                    "\n          SI NO ACEPTA ESTOS TERMINOS, HAGA CLIC EN (NO ACEPTO) Y NO UTILICE ESTE SOFTWARE.");
  ...
  public static void main(String args[]){
   CcuarentaytresLicencia ventanalicencia = new CcuarentaytresLicencia();
